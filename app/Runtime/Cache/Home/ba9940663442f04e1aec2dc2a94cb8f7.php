...
<?php include("public/include/navbar.php") ?>  <?php include("public/include/left-nav.php") ?>    
    ...
    <div class="content">
        ...
        <ul class="breadcrumb">
            <li>示范企业查询<span class="divider">/</span></li>
        </ul>
...
<div class="row-fluid">
    <div class="block">
        ...
        <form action="index.php?m=Unit&a=company_search_list" method="post">	
        	<div class="well">
                <label>年度</label>
                <select name="year"> 
					<option value="不关心">不关心</option>                    
