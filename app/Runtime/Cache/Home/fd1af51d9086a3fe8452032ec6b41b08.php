...
<div class="sidebar inner">
  ...
  <dl class="list-none navnow"><dt id='part2_8'><a href=__URL__/jiajiaojianzhixinxi  title='家教兼职信息' class="zm" onclick="change5()"><span>家教兼职信息</span></a></dt></dl>     
    ...
    <div class="sb_box" id="box4" style="display:block">
	    <h3 class="title">
			<span>发布文章</span>
		</h3>
		<div class="clear"></div>
        <form style="margin:20px 10px" method="post" action=__URL__/addinfo >
        	发布板块：<select name="kind"><option value="1">通知公告</option><option value="2">新闻中心</option><option value="3">家教心得</option><option value="7">中心简介</option><option value="9">成果展示</option><option value="8">家教须知</option></select>
            标题：<input type="text" name="title"/>
            <div class="clear"></div>
            <br />
                <link rel="stylesheet" href="/public/htmleditor/themes/default/default.css" />
                <script charset="utf-8" src="/public/htmleditor/kindeditor-min.js"></script>            
			<textarea name="content" style="width:100%;height:700px;visibility:hidden;">KindEditor</textarea>            
            <br />
            <input id="unitPassword_sub" style="margin-left:300px" type="submit" value="提交">
        </form>
	</div>
