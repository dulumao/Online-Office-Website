        ...
        <div id="page-stats" class="block-body collapse in">
            ...
            <div class="well">
                ...
                <div class="myForm">
                    ...
                    <li><span class="li_left span7">上年销售收入（元）：</span><?php echo ($info["income"]); ?></li>
                ...
                <div class="myForm">
                    ...
                    <li><span class="li_left span6">上年利润（元）：</span><?php echo ($info["profit"]); ?></li>
                    <li><span class="li_left span6">职工人数：</span><?php echo ($uinfo["worker"]); ?></li>
                    <li><span class="li_left span6">上年税金（元）：</span><?php echo ($info["tax"]); ?></li>
                    </ul>
                </div>
            </div>
            <div class="well">
                ...
                <div class="myForm">
                    <ul>
                    <li><span class="li_left span6">项目总投资（元）：</span><?php echo ($info["totalmoney"]); ?></li>
                    <li><span class="li_left span6">自筹（元）：</span><?php echo ($info["self"]); ?></li>
                    <li><span class="li_left span6">银行贷款（元）：</span><?php echo ($info["bankloan"]); ?></li>
                    </ul>
                </div>
                <div class="myForm">
                    <ul>
                    <li><span class="li_left span7">申请专项资金（元）：</span><?php echo ($info["get"]); ?></li>
...
<div class="row-fluid">
    <div class="block">
        <a href="#page-stats2" class="block-heading" data-toggle="collapse">项目进度报告</a>
        <div id="page-stats2" class="block-body collapse in">
        	<div class="well">
                ...
                <table class="table">
				  ...
				  <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="index.php?m=Country&a=getf&id=<?php echo ($li["id"]); ?>&fid=<?php echo ($li["fid"]); ?>"><?php echo ($li["name"]); ?></a></td>                     
                      <td><?php echo ($li["time"]); ?></td>
                      <td>
                          <a href="index.php?m=Country&a=removef&id=<?php echo ($li["id"]); ?>&fid=<?php echo ($li["fid"]); ?>"><i class="icon-remove"></i></a>
                      </td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                  </tbody>
    ...
    <div class="block">
        ...
        <div id="page-stats3" class="block-body collapse in">
        	<div class="well">
            	<div class="myForm">
                    <ul>
                    <li><span class="li_left span6">上报渠道：</span><?php echo ($info["upload1"]); ?></li>
                    <li><span class="li_left span6">地市或集团：</span><?php echo ($info["upload2"]); ?></li>
                    </ul>
                </div>
            </div>
        </div>
