    ...
    <div class="row">
    	<div class="box pull-left">
            <ol class="breadcrumb" style="float:left; width:620px">
                ...
                <li style="float:left"><a href="index.php?m=Index&a=message">在线留言</a> <span class="divider">/</span></li>
            ...
            <div class="meassage_box">
                ...
                <span class="meassage_box_time"><?php echo ($msg["time"]); ?></span>
                <p><?php echo ($msg["content"]); ?></p>
            </div>
            <div class="well well-small meassage_box_r">
            	<span>回复于：<?php echo ($msg_b["time"]); ?></span>
            	<p><strong>管理员回复：</strong><?php echo ($msg_b["title"]); ?></p>
				<p>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($msg_b["content"]); ?></p>
            </div>
			<!--
            <div class="pagination text-center">
                <ul>
                    <li><a href="index.php?m=Index&a=message_content&id=<?php echo ($li["upid"]); ?>">上一条：<?php echo ($li["uptitle"]); ?></a></li>
                    <li><a href="index.php?m=Index&a=message_content&id=<?php echo ($li["downid"]); ?>">下一条：<?php echo ($li["downtitle"]); ?></a></li>
                </ul>
            </div>   
			-->         
        </div>
