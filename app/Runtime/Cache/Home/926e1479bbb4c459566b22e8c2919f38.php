...
<div class="row-fluid">
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
        	<div class="well">
            	<form action="index.php?m=Country&a=change_password" method="post">
                    <label>原密码：</label>
                    <input class="input-xlarge" type="password" name="o" />
                    <label>新密码：</label>
                    <input class="input-xlarge" type="password" name="n1" />
                    <label>确认新密码：</label>
                    <input class="input-xlarge" type="password" name="n2" />
