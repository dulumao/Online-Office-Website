...
<div class="sidebar inner">
    ...
    <div class="sb_box">
	    <h3 class="title"><span>单位一览</span></h3>
		<div class="clear"></div>
        <div class="editor active" id="showtext">
		    <div>
            <!----->
            <div class="about2">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div id="about2_<?php echo ($vo["id"]); ?>" class="about2_all">
				 
                    <a href="javascript:;" onmouseover="document.getElementById('about2_<?php echo ($vo["id"]); ?>').className = 'about2_all_yes'" onmouseout="document.getElementById('about2_<?php echo ($vo["id"]); ?>').className = 'about2_all'"><?php echo ($vo["name"]); ?></a>
                    <p><?php echo ($vo["des"]); ?></p>
                </div>
