...
<div class="sidebar inner">
    <div class="sb_nav">
			...
			<div class="active" id="sidebar" data-csnow="19" data-class3="0" data-jsok="2">
            	<dl class="list-none navnow">
                    ...
                    <a href=index.php?m=Index&a=about   title='中心简介' class="zm">
                    <span>中心简介</span></a></dt>
                </dl>
                <dl class="list-none navnow">
                	<dt id='part2_25'>
                    <a href=index.php?m=Index&a=about2   title='单位一览' class="zm">
                    <span>单位一览</span></a></dt>
                </dl>
                <dl class="list-none navnow">
                	<dt id='part2_31'>
                    <a href=index.php?m=Index&a=about3   title='成果展示' class="zm">
                    <span>成果展示</span></a></dt>
                </dl>
                <div class="clear"></div>
            </div>
    ...
    <div class="sb_box">
	    <h3 class="title"><span>勤工概况</span></h3>
		<div class="clear"></div>
