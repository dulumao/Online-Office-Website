    ...
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
                ...
                <table class="table">
                  ...
                  <tbody>
                    <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="index.php?m=Admin&a=com&id=<?php echo ($li["claimid"]); ?>"><?php echo ($li["unit"]); ?></a></td>
            ...
            <div class="btn-toolbar">
                <a class="btn btn-primary" href="index.php?m=Admin&a=getexcel&id=<?php echo ($id); ?>"><i class="icon-save"></i> 导出EXCEL</a>
                <a class="btn" href="index.php?m=Admin&a=project_search">重新搜索</a>
            </div>
        </div>                    
    </div>  
</div>
