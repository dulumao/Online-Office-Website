...
<div class="sidebar inner">
  ...
  <dl class="list-none navnow"><dt id='part2_8'><a href=__URL__/jiajiaojianzhixinxi  title='家教兼职信息' class="zm" onclick="change5()"><span>家教兼职信息</span></a></dt></dl>     
    ...
    <div class="sb_box" id="box5" style="display:block">
        ...
        <form style="margin:20px 0 0 50px" action=__URL__/addjiajiao method="post">
	        <h2>添加信息</h2>
        	<ul>
            	<li>年级：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="nianji"/></li>
            	<li>性别：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="xingbie"/></li>
            	<li>住址：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="dizhi"/></li>
            	<li>科目：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="kemu" /></li>
				<li>联系方式&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="lianxifangshi" /></li>
            	<li>需求：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="xuqiu" /></li>                
            </ul>
            <input type="submit" value="添加" id="unitPassword_sub" style="margin-bottom:0">
        </form>
        	...
        	<table id="worklist" cellspacing="0" cellpadding="0">
              <tr class="worklist_root">
			   ...
			   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
              	...
              	<td><?php echo ($vo["xingbie"]); ?></td>
              	<td><?php echo ($vo["dizhi"]); ?></td>
              	<td><?php echo ($vo["kemu"]); ?></td>
				<td><?php echo ($vo["lianxifangshi"]); ?></td>
              	<td><?php echo ($vo["xuqiu"]); ?></td>
                <td><a href=__URL__/deletejiajiaojianzhi?id=<?php echo ($vo["id"]); ?>>删除</a></td>
