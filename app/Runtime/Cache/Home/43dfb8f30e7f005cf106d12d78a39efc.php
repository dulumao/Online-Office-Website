    ...
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
            <div class="well">
                ...
                <div class="myForm">
                	<ul>
					 <li><span class="li_left span6">申请类别：</span><?php echo ($cinfo["level"]); ?></li>
        	...
        	<div class="well">
                <table class="table">
                  ...
                  <tbody>
                      ...
                      <td><a href="index.php?m=Country&a=getfile_1&id=<?php echo ($finfo["id"]); ?>&fid=<?php echo ($finfo["fid"]); ?>"><?php echo ($finfo["name"]); ?></a></td>                      
