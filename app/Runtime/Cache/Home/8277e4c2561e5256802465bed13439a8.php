        ...
        <form action="index.php?m=Unit&a=company_progress" method="post" enctype="multipart/form-data">	
            ...
            <div class="well">
                ...
                <div class="myForm">
                    ...
                    <label>总资产（元）：</label>
                    <input type="text" value="<?php echo ($uinfo["unittotalmoney"]); ?>" class="input-xlarge" readonly="readonly">
                    <label>资金负债率（%）：</label>
                    <input type="text" value="<?php echo ($uinfo["betmoneyrate"]); ?>" class="input-xlarge" readonly="readonly">
                    <label>单位地址：</label>
                    <input type="text" value="<?php echo ($uinfo["unitaddr"]); echo ($uinfo["deatiladdr"]); ?>" class="input-xlarge" readonly="readonly">
                </div>
                <div class="myForm">
                    <label>注册登记类型：</label>
                    ...
                    <input type="text" value="<?php echo ($cinfo["income"]); ?>" class="input-xlarge" name="income">
                    <label>银行信用等级：</label>
                    <select class="input-xlarge">
                    ...
                    <label>单位邮编：</label>
                    <input type="text" value="<?php echo ($uinfo["unitpostcode"]); ?>" class="input-xlarge" readonly="readonly">                    
                </div>
                <div class="myForm">
                    <label>注册资本（元）：</label>
                    ...
                    <label>上年利润（元）：</label>
                    <input type="text" value="<?php echo ($cinfo["profit"]); ?>" class="input-xlarge" name="profit">
                    <label>职工人数：</label>
                    <input type="text" value="<?php echo ($uinfo["worker"]); ?>" class="input-xlarge" readonly="readonly">
                    <label>上年税金（元）：</label>
                    <input type="text" value="<?php echo ($cinfo["tax"]); ?>" class="input-xlarge" name="tax" >                    
                </div>
            </div>
            <div class="well">
            	<h3>企业自荐信息</h3>
                <textarea style="width:97%" rows="10" name="self"><?php echo ($cinfo["self"]); ?></textarea>
            </div>     
								  ...
								  <!--以下为文件删除确认框--> 
									<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="modal-footer">
											...
											<a class="btn btn-danger"  href="index.php?m=Unit&a=rrr&id=<?php echo ($cinfo["id"]); ?>&fid=<?php echo ($finfo["fid"]); ?>">删除</a>
										</div>
									</div>                       
							  </td>
