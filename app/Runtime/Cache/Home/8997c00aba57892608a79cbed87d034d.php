...
<script type="text/javascript" src="public/country/lib/highslide/highslide-with-html.js"></script>
<link rel="stylesheet" type="text/css" href="public/country/lib/highslide/highslide.css" />
<script type="text/javascript">
	hs.graphicsDir = 'public/country/lib/highslide/graphics/';
...
<?php include("public/country/include/navbar.php") ?>        
<?php include("public/country/include/left-nav.php") ?> 
            ...
            <table class="table">
              ...
              <tbody>
			    <?php if(is_array($msglist)): $i = 0; $__LIST__ = $msglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vomsg): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                  <a href="public/country/lib/highslide-4.1.13/examples/index.htm" onclick="return hs.htmlExpand(this, { headingText: '<?php echo ($vomsg["title"]); ?>' })">
                  ...
                  <td>
                     <td><a href="index.php?m=Country&a=delmsg&id=<?php echo ($vomsg["id"]); ?>">删除</a></td>
					 <td><a href="index.php?m=Country&a=readmsg&id=<?php echo ($vomsg["id"]); ?>">标记为已读</a></td>
                  </td>
...
<div class="row-fluid">
    <div class="block">
        ...
        <div id="page-stats" class="block-body collapse in">
        	<div class="well">
				<form id="returnMessage" action="index.php?m=Country&a=message" method="post">
                <label>接收方：</label>       
...
<?php include("public/country/include/footer.php") ?>                    
            </div></div>
