...
<div class="row-fluid"><!--若本区域无内容，请勿显示-->
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">项目进度查看</a>
                ...
                <table class="table">
                  ...
                  <tbody>
                      ...
                      <td><?php echo ($l1["pid"]); ?></td>
					   <th><a href="index.php?m=Admin&a=app_project_content&id=<?php echo ($l1["id"]); ?>"><?php echo ($l1["proname"]); ?></a></th>	
					   <td><a href="index.php?m=Admin&a=com&id=<?php echo ($l1["claimid"]); ?>"><?php echo ($l1["unit"]); ?></a></td>					 					 				  
                      <td><?php echo ($l1["reporttime"]); ?></td>
                      <td><?php echo ($l1["report"]); ?></td>					 
