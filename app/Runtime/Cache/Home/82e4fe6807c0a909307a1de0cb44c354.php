...
<body class="">
  ...
  <div class="content">
    ...
    <div class="header">
      <h1 class="page-title">设置密码找回邮箱</h1>
    </div>
        ...
        <div class="block">
          ...
          <div id="page-stats" class="block-body collapse in">
            <table class="table">
              <thead>
                <tr>
                  <th>邮箱用户名(如:xiepan1990929@126.com)</th>
                  <th>邮箱密码</th>                 
              ...
              <tbody>
                <?php if(is_array($l1)): $i = 0; $__LIST__ = $l1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l1): $mod = ($i % 2 );++$i;?><tr>          
				  <form action="index.php?m=Admin&a=set_mail" method="post">    
				  	<input name="id" value="<?php echo ($l1["id"]); ?>" type="hidden"/>     
                    <td><input name="u" value="<?php echo ($l1["u"]); ?>" /></td>
                    <td><input name="p" value="<?php echo ($l1["p"]); ?>" /></td>
