...
<body class="">
  ...
  <div class="content">
    ...
    <div class="header">
      <h1 class="page-title">区县管理账户列表</h1>
    </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="block">
          <a href="#page-stats" class="block-heading" data-toggle="collapse">区县管理账户列表</a>
            ...
            <table class="table">
              ...
              <tbody>
                <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($li["password"]); ?></td>
                    <td><?php echo ($li["region"]); ?></td>
                    <td><?php echo ($li["time"]); ?></td>
                    <td>
                      <a href="index.php?m=Admin&a=delm&id=<?php echo ($li["id"]); ?>" role="button"> <i class="icon-remove"></i>
                      </a>

                      <a href="index.php?m=Admin&a=admin_change&id=<?php echo ($li["id"]); ?>"> <i class="icon-pencil"></i>
                      </a>
                    </td>
                  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
              </tbody>
            </table>
            <a class="btn btn-primary" href="index.php?m=Admin&a=getexcel_admin">
              <i class="icon-save"></i>
              账户信息为导出EXCEL
            </a><br><br>
          </div>
