        	...
        	<div class="well">
                <table class="table">
                  ...
                  <tbody>
                      ...
                      <td><a href="index.php?m=Admin&a=getfile&id=<?php echo ($finfo["id"]); ?>&nid=<?php echo ($finfo["nid"]); ?>"><?php echo ($finfo["name"]); ?></a></td>                      
        	...
        	<div class="well">
                ...
                <table class="table">
				  ...
				  <?php if(is_array($li)): $i = 0; $__LIST__ = $li;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$li): $mod = ($i % 2 );++$i;?><tr>
                      ...
                      <td><a href="index.php?m=Admin&a=getf&id=<?php echo ($li["id"]); ?>&fid=<?php echo ($li["fid"]); ?>"><?php echo ($li["name"]); ?></a></td>                     
                      <td><?php echo ($li["time"]); ?></td>
                      <td>
                          <a href="index.php?m=Admin&a=removef&id=<?php echo ($li["id"]); ?>&fid=<?php echo ($li["fid"]); ?>"><i class="icon-remove"></i></a>
                      </td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                  </tbody>
