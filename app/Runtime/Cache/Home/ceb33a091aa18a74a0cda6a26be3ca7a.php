...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="http-error">
        <h1>恭喜，注册成功</h1>
        <p class="info">1.您的账户需要经过管理员审核后才能使用，请耐心等待.</p>
		<p class="info">2.请不要重复注册帐号，系统将会拒绝来自同一台机器的多个注册请求.</p>
		<p class="info">3.如果确实需要在本机注册多个帐号，联系管理员.</p>
        <p><a href="index.php?m=Index&a=index"><i class="icon-home"></i></a></p>
