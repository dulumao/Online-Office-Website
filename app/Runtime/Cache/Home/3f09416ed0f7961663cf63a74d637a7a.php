		...
		<div class="inner">
			<div class="top-logo">
				...
				<ul class="top-nav list-none">
					<li class="t">
                    	<a href=index.php?m=Index&a=user_login  title="登录" target="_self">登录</a>
                        <span>|</span>
...
<div class="sidebar inner">
    ...
    <div class="sb_box" style="width:980px">
        ...
        <div class="active" id="newslist">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class='list top'><span>[<?php echo ($vo["date"]); ?>]</span><a href=index.php?m=Index&a=download?id=<?php echo ($vo["id"]); ?> title='<?php echo ($vo["title"]); ?>' target='_blank'><?php echo ($vo["title"]); ?></a><p></p></li><?php endforeach; endif; else: echo "" ;endif; ?>        
...
<footer data-module="4" data-navdown="32" data-classnow="32">
	<div class="inner">
		<div class="foot-text">
			<p>西安交通大学勤工助学中心</p>
			<p>本站由极光工作室负责维护</p>
