            ...
            <table class="table">
              ...
              <tbody>
			    <?php if(is_array($msglist)): $i = 0; $__LIST__ = $msglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vomsg): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td>
                  <a href="public/admin/lib/highslide-4.1.13/examples/index.htm" onclick="return hs.htmlExpand(this, { headingText: '<?php echo ($vomsg["title"]); ?>' })">
                  ...
                  <td>
                     <td><a href="index.php?m=Admin&a=delmsg&id=<?php echo ($vomsg["id"]); ?>">删除</a></td>
					 <td><a href="index.php?m=Admin&a=readmsg&id=<?php echo ($vomsg["id"]); ?>">标记为已读</a></td>
                  </td>
