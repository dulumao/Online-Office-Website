...
<head>
  ...
  <!--date picker-->
  <?php include("public/admin/include/datepicker.php") ?>
      ...
      <div class="row-fluid">
        <div class="block">
          ...
          <p style="text-align:center">
            <a href="unit_Help.pptx" title="" target="_blank">[企业端帮助文件]</a>
            <a href="admin_Help.pptx" title="" target="_blank">[区县管委会端帮助文件]</a>
            <a href="root_Help.pptx" title="" target="_blank">[管理员端帮助文件]</a>
          </p>
