...
<div class="row-fluid">
    <div class="block">
        <a href="#page-stats" class="block-heading" data-toggle="collapse">修改密码</a>
        <div id="page-stats" class="block-body collapse in">
        	<div class="well">
            	<form action="index.php?m=Unit&a=change_password" method="post">
                    <label>原密码：</label>
                    <input class="input-xlarge" type="password" name="old" />
                    <label>新密码：</label>
                    <input class="input-xlarge" type="password" name="new1" />
                    <label>确认新密码：</label>
                    <input class="input-xlarge" type="password" name="new2" />
                    <div class="alert alert-info"  id="changePasswordAlert" style="display:<?php echo ($style); ?>">
                        <button type="button" class="close" data-dismiss="alert">×</button>
                        <strong>操作提示：</strong><?php echo ($notify); ?>
                    </div>
                    <div class="clear"></div>                   
                    <input class="btn btn-primary" type="submit" onclick="changePasswordAlert();" value="确认修改"/>
                </form>           
            </div>
        </div>
    </div>
