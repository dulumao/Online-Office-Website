		...
		<div class="inner">
			<div class="top-logo">
				...
				<ul class="top-nav list-none">
					<li class="t">
                    	<a href=index.php?m=Index&a=login title="登录" target="_self"><?php echo ($user); ?></a>
                        <span>|</span>
...
<div class="sidebar inner">
    <div class="sb_nav">
            ...
            <dl class="list-none navnow"><dt id='part2_4'><a href=index.php?m=Index&a=admin_content  title='通知公告' class="zm" onclick="change1()"><span>通知公告</span></a></dt></dl>
            <dl class="list-none navnow"><dt id='part2_5'><a href=index.php?m=Index&a=xinwenzhongxin  title='新闻中心' class="zm" onclick="change2()"><span>新闻中心</span></a></dt></dl>
            <dl class="list-none navnow"><dt id='part2_6'><a href=index.php?m=Index&a=jiajiaoxinde  title='家教心得' class="zm" onclick="change3()"><span>家教心得</span></a></dt></dl>
            <dl class="list-none navnow"><dt id='part2_7'><a href=index.php?m=Index&a=fabuwenzhang  title='发布文章' class="zm" onclick="change4()"><span>发布文章</span></a></dt></dl>
  <dl class="list-none navnow"><dt id='part2_8'><a href=index.php?m=Index&a=jiajiaojianzhixinxi  title='家教兼职信息' class="zm" onclick="change5()"><span>家教兼职信息</span></a></dt></dl>     
            <dl class="list-none navnow"><dt id='part2_9'><a href=index.php?m=Index&a=ziliaoshangchuan  title='资料上传' class="zm" onclick="change6()"><span>资料上传</span></a></dt></dl>
    ...
    <div class="sb_box" id="box6" style="display:block">
	    <h3 class="title">
			<span>资料上传</span>
		</h3>
        <form style="margin:30px 0 30px 50px" action=index.php?m=Index&a=ziliaoshangchuan method="post" enctype="multipart/form-data">
        	标题：<input type="text" name="title" /><br /><br />
            地址：<input name="uploadfile" type="file" /><br /><br />
			类型：<select name="xiazai"><option value="1">供下载</option><option value="0">首页展示</option></select><br /><br />
			链接：<input name="link" type="text" /><br /><br />
            <input id="unitPassword_sub" style="margin-left:50px" value="上传" type="submit"/>
        </form>
			<form style="margin:50px auto">
        	<table id="worklist" cellspacing="0" cellpadding="0">
              <tr class="worklist_root">
               ...
               <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href=index.php?m=Index&a=download?id=<?php echo ($vo["id"]); ?>>index.php?m=Index&a=download?id=<?php echo ($vo["id"]); ?></a></td>
                <td><?php echo ($vo["date"]); ?></td>
                <td><?php echo ($vo["count"]); ?></td>
                <td><a href=index.php?m=Index&a=deletenews?id=<?php echo ($vo["id"]); ?>>删除</a></td>
